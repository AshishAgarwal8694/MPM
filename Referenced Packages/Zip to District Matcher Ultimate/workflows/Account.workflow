...
USPS_Street__c &amp; &quot;, &quot; &amp; USPS_Street_2__c
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_County_Code</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Error_Code</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_House</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Latitude</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Longitude</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Muni_Code</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Muni_Name</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Muni_Type</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_PO_Box_Reset</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Senate</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_State_House</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_State_Senate</fullName>
    ...
    <fieldUpdates>
        <fullName>ZDM_Account_Zip_4_Reset</fullName>
    ...
    <rules>
        <fullName>Reset Processed Date</fullName>
        <actions>
            <name>ZDM_Account_County_Code</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_County_Name</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_House</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Muni_Code</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Muni_Name</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Muni_Type</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Senate</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_State_House</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_State_Senate</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
        <description>Reset ZDM Address Fields when address changed</description>
        <formula>AND (   OR(  ISCHANGED( BillingStreet),   ISCHANGED( BillingCity),   ISCHANGED( BillingState),   ISCHANGED( BillingPostalCode)  ),  KnowWho_Address_Update__c = FALSE  )</formula>
        <triggerType>onAllChanges</triggerType>
    </rules>
    <rules>
        <fullName>Reset ZDM Account Descr Fields on Address Update</fullName>
        <actions>
    ...
    <rules>
        <fullName>Reset ZDM Account Fields on Address Update</fullName>
        <actions>
            <name>Reset_Last_Processed_Date</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Error_Code</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Latitude</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Longitude</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_PO_Box_Reset</name>
            <type>FieldUpdate</type>
        </actions>
        <actions>
            <name>ZDM_Account_Zip_4_Reset</name>
            <type>FieldUpdate</type>
        </actions>
        <active>true</active>
    ...
    <rules>
        ...
        <active>true</active>
        <criteriaItems>
            <field>Account.USPS_Verified__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
        <criteriaItems>
            <field>Account.KnowWho_Address_Update__c</field>
            <operation>equals</operation>
            <value>True</value>
        </criteriaItems>
